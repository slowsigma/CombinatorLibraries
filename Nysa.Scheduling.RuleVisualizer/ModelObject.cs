    ...
    public static class IModelObjectExtensions
    {
            ...
            where T : class
        {
            if (propertyField != newValue)
            {
                ...
                changeNotifyPropertyNames.Process(p => modelObject.OnPropertyChanged(new PropertyChangedEventArgs(p)));
    ...
    public abstract class ModelObject : INotifyPropertyChanged, IModelObject
    {
            ...
            where T : class
        {
            if (propertyField != newValue)
            {
                ...
                if (this.PropertyChanged != null) changeNotifyPropertyNames.Process(p => this.PropertyChanged(this, new PropertyChangedEventArgs(p)));
        ...
        {
            affectedPropertyNames.Process(p =>
            {
        ...
        protected void NotifyChanged(IEnumerable<INotifyPropertyChanged> constituents, params String[] affectedPropertyNames)
        {
            Action<Object, PropertyChangedEventArgs> handler =
                (sender, e) =>
                {
                    if (this.PropertyChanged != null) affectedPropertyNames.Process(p => this.PropertyChanged(this, new PropertyChangedEventArgs(p)));
                };

            constituents.Process(c => c.PropertyChanged += new PropertyChangedEventHandler(handler));
        }
